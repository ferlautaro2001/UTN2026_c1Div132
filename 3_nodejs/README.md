...
/////////////////////////
// http: Modulo que nos permitira crear un servidor web sin tener que instalar nada adicional
...
#### Para detener la ejecucion del servidor usaremos `Ctrl + C`, para copiar en una terminal es `Ctrl + Shift + C`, lo mismo para pegar, `Ctrl + Shift + V`